...
# from src.ai.llm.invoke import invoke_structured_async
# from src.ai.edit_prompts.edit_platforms_prompt import edit_classifier_template, mode_a_revision_template , mode_b_context_update_template
# from src.ai.edit_prompts_2.proposal_prompts.proposed_system_prompt import proposed_system_ar_template
...
# class ProposedSystemEditClassification(BaseModel):

#     mode: EditMode
#     reason :str
#     affected_entities: List[str]= Field(default_factory=list)

# class PlatformServie:

#     def __init__(self):
#         pass

#     async def modify_proposed_system(self,enhanced_context,original_content,edit_content):
...
#                               },
#                               output_model=ProposedSystemEditClassification,
...
# platform_service=PlatformServie()